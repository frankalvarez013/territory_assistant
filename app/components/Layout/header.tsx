...
export default function Header() {
  ...
  return (
    <header className=" bg-[rgb(65,105,225)] h-16 flex justify-around items-center fixed w-full z-10 text-white">
      ...
      <div className=" visible sm:hidden" onClick={() => setMenuOpen(!menuOpen)}>
        {menuOpen ? (
          <>
            <XIcon className="h-6 w-6" aria-hidden="true" />

            <nav className="absolute bg-[rgb(65,105,225)] right-0 pt-4 h-40 bg-opacity-95 justify-evenly flex flex-col basis-1/2 px-3">
